...
public abstract class BaseSliderView {
    ...
    public Callback loadImage(RoundedImageView ivUser, RoundedImageView placeHolderImage, String url) {
        return new callback(ivUser, placeHolderImage, url);
    }
    ...
    public class callback implements Callback {
        ...
        public callback(RoundedImageView imageView, RoundedImageView placeHolderImage, String url) {
     ...
     */
    protected void bindEventAndShow(final View v, RoundedImageView targetImageView, RoundedImageView placeHolderImage) {
        ...
        if (mLoadListener != null) {
            ...
            //v.findViewById(R.id.loading_bar).setVisibility(View.INVISIBLE);//added by me
        }
        Picasso.with(mContext)
                .load(mUrl)
        ...
        rq.placeholder(R.drawable.a_place_holder_detail_page).error(R.drawable.a_place_holder_detail_page);
        switch (mScaleType) {
            case Fit:
                rq.fit();
                break;
        ...
        rq.transform(new RoundedTransformation(20, 0));
