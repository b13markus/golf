...
public class Constants {
    ...
    public static final String app_name = "GC Crans sur Sierre";
    public static final String clientId = "6499";
    ...
    public static int CLEAR_BACKSTACK_TIME_IN_SECONDS = 10*60;
