...
public class Constants {
    ...
    public static final String app_name = "Golf Parc Signal de Bougy";
    public static final String clientId = "141";

    public static int draw = 7;
    public static String OLD_LANGUAGE = "golf_app_user_141_old_language";
    ...
    public static final String webServiceUrl = "http://golfapp.ch/app/api/"/*"http://golfapp.ch/app/api/"*/;
    //Required Fields
    ...
    public static int AD_SERVING_TIME_IN_SEC = 900;      // 15 min
    public static int CLEAR_BACKSTACK_TIME_IN_SECONDS = 600;    //10 min
    public static final long TASK_KILL_DURATION_IN_MILISECONDS = 600 * 1000;
