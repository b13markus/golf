 ...
 */
public class ProshopData extends SugarRecord<ProshopData> {
    ...
    public ProshopData(int proShopID, int position, int package_count, double longitude, double latitude,
