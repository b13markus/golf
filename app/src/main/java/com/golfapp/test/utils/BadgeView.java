...
public class BadgeView extends TextView {
    ...
    public BadgeView(Context context, AttributeSet attrs, int defStyle) {
        ...
        setTypeface(Typeface.createFromAsset(context.getAssets(), "fonts/B.ttf"));
        init();
    }
    ...
    private void init() {
      ...
      //  setTypeface(Typeface.createFromAsset(context.getAssets(), "fonts/B.ttf"));
       ...
       // setPadding(dip2Px(7), dip2Px(2), dip2Px(7), dip2Px(2));

        // set default background
        setBackground(17, Color.parseColor("#FF0000"));
    ...
    public void setBackground(int dipRadius, int badgeColor) {
        ...
        Drawable d = getResources().getDrawable(R.drawable.round);
